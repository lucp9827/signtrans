...
result.selected.references <- dacomp.select_references(counts,median_SD_threshold=2.1,verbose = T)# Verbose = TRUE: prints computation progress
...
final <- Select_Ref_frame(data_res,threshold=2.1)
```
